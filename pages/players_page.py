...
class PlayersPage (BasePage):
    ...
    def click_on_the_players(self, text, text2, text3):
        self.assert_element_text(self.driver, self.name_column_xpath, text)
        self.assert_element_text(self.driver, self.surname_column_xpath, text2)
        self.assert_element_text(self.driver, self.main_position_column_xpath, text3)
        self.click_on_the_element(self.first_line_table_xpath)
